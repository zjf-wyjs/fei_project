...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES (31, 1, '关于', 'sys/about', 'sys:about:save,sys:about:info', 1, 'dangdifill', 0);
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES (32,1,'banner','sys/banner','substance:banner:list,substance:banner:info,substance:banner:save,substance:banner:update,substance:banner:delete',1,'editor',0);
...
CREATE TABLE `fei_project`.`tb_about` ( `id` INT NOT NULL AUTO_INCREMENT, `content` LONGTEXT, `update_time` DATETIME, PRIMARY KEY (`id`) );
CREATE TABLE `fei_project`.`tb_banner` ( `id` INT NOT NULL AUTO_INCREMENT, `path` VARCHAR(550) COMMENT '图片地址', `remarks` VARCHAR(200) COMMENT '备注', `status` TINYINT COMMENT '显示状态；-1:不显示 1：显示', `sort` INT COMMENT '排序字段', `param` VARCHAR(500) COMMENT '参数', PRIMARY KEY (`id`) );
